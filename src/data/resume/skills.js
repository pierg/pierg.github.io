...
const skills = [
  {
    title: 'A Grammar for the Representation of Unmanned Aerial Vehicles with 3D Topologies',
    authors: 'Piergiuseppe Mallozzi, Hussein Sibai, Inigo Incer, Sanjit A. Seshia, Alberto Sangiovanni-Vincentelli',
    venue: 'under review',
    year: 2023,
    category: ['Autonomous Vehicles', 'Requirement Engineering', 'Formal Verification'],
  ...
  },
  {
    ...
    authors: 'Inigo Incer, Apurva Badithela, Josefine Graebener, Piergiuseppe Mallozzi, Ayush Pandey, Sheng‐Jung Yu, Albert Benveniste, Benoit Caillaud, Richard Murray, Alberto Sangiovanni‐Vincentelli, Sanjit Seshia',
    venue: 'submitted to CAV23',
    year: 2023,
    category: ['Requirement Engineering', 'Formal Verification', 'Contract-Based Design'],
    pdflink: '',
    file: '',
  },
  {
